...
import br.com.bancoamericano.mspayment.exception.exceptions.RequiredObjectIsNullException;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> handleNotFoundExceptions(PaymentNotFoundException ex, WebRequest request) {
        var response = new ExceptionResponse(new Date(),
                ex.getMessage(),
                request.getDescription(false),
